...
/datum/admins/proc/log_admin_rank_modification(var/adm_ckey, var/new_rank)
	...
	if(new_admin)
		...
		var/datum/db_query/log_query = SSdbcore.NewQuery("INSERT INTO `ss13`.`erro_admin_log` (`id` ,`datetime` ,`adminckey` ,`adminip` ,`log` ) VALUES (NULL , NOW( ) , '[usr.ckey]', '[usr.client.address]', 'Added new admin [adm_ckey] to rank [new_rank]');") //CHOMPEdit TGSQL
		log_query.Execute()
		...
		if(!isnull(admin_id) && isnum(admin_id))
			...
			insert_query.Execute()
			qdel(insert_query) //CHOMPEdit TGSQL
			var/datum/db_query/log_query = SSdbcore.NewQuery("INSERT INTO `ss13`.`erro_admin_log` (`id` ,`datetime` ,`adminckey` ,`adminip` ,`log` ) VALUES (NULL , NOW( ) , '[usr.ckey]', '[usr.client.address]', 'Edited the rank of [adm_ckey] to [new_rank]');") //CHOMPEdit TGSQL
			log_query.Execute()
			qdel(log_query) //CHOMPEdit TGSQL
...
/datum/admins/proc/log_admin_permission_modification(var/adm_ckey, var/new_permission)
	...
	if(admin_rights & new_permission) //This admin already has this permission, so we are removing it.
		...
		insert_query.Execute()
		qdel(insert_query) //CHOMPEdit TGSQL
		var/datum/db_query/log_query = SSdbcore.NewQuery("INSERT INTO `ss13`.`erro_admin_log` (`id` ,`datetime` ,`adminckey` ,`adminip` ,`log` ) VALUES (NULL , NOW( ) , '[usr.ckey]', '[usr.client.address]', 'Removed permission [rights2text(new_permission)] (flag = [new_permission]) to admin [adm_ckey]');") //CHOMPEdit TGSQL
		log_query.Execute()
		qdel(log_query) //CHOMPEdit TGSQL
		...
		insert_query.Execute()
		qdel(insert_query) //CHOMPEdit TGSQL
		var/datum/db_query/log_query = SSdbcore.NewQuery("INSERT INTO `ss13`.`erro_admin_log` (`id` ,`datetime` ,`adminckey` ,`adminip` ,`log` ) VALUES (NULL , NOW( ) , '[usr.ckey]', '[usr.client.address]', 'Added permission [rights2text(new_permission)] (flag = [new_permission]) to admin [adm_ckey]')") //CHOMPEdit TGSQL
		log_query.Execute()
		qdel(log_query) //CHOMPEdit TGSQL
